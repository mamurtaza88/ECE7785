...
class goToGoal:
    ...
    def follow_callback(self, ros_data):
        ...
        if self.waypointStatus == 1:
            ...
            error_angle = np.arctan2(ref_position_y-current_position_y,ref_position_x-current_position_x)
            ...
            if not self.stop_flag: 
                if self.counter%2==0:
                    ...
                    error_angle = 0
                pid_x = kp_x*error
                pid_angle = 35*kp_angle*error_angle*error
            ...
            if self.waypointStatus_inner==0:
                ...
                ref_position_x = 1.5
                ref_position_y = 1.5
                ref_angle = np.arctan2(ref_position_y-current_position_y,ref_position_x-current_position_x)+0.12 #math.pi/2 - np.arctan2(0.7,0.5)
            ...
            ref_position_x = 0
            ref_position_y = 1.3
            ref_angle = np.arctan2(ref_position_y-current_position_y,ref_position_x-current_position_x)#math.pi/2 - np.arctan2(0.7,0.5)
            # ref_angle = np.pi-0.1
            if ref_angle <0:
                ref_angle+=2*np.pi
            error_angle = current_Orientation-ref_angle
            ...
            if self.waypointStatus_inner_4 == 1:
                ...
                if self.go_straight:
                    ...
                    if current_position_x>ref_position_x:
                        error = -error
                    #error = current_position_x-ref_position_x
                    error_angle = np.arctan2(ref_position_y-current_position_y,ref_position_x-current_position_x) - np.pi
    ...
    def if_obstacle(self, current_orientation, current_position_y,current_position_x, kp_angle, kp_x):
        ...
        if self.now_move:
            # go forward
            error_dist = current_position_y - (self.detected_obstacle_pos_y+0.8)
    ...
    def move_forward(self, x, y, theta, angle_off=False):
        self.first=False
        vel_msg = Twist()
        self.counter += 1
        # print("Entering WaypointStatus = ", self.waypointStatus)
        ...
        error = math.sqrt((self.current_position_x - ref_position_x) ** 2 +(self.current_position_y - ref_position_y) ** 2 )
        # if self.current_position_x > ref_position_x:
        #     error = -error
        # error = current_position_x-ref_position_x
        curr_angle = np.arctan2(ref_position_y - self.current_position_y, ref_position_x - self.current_position_x)

...
lower= np.array([159,19,7],np.uint8) # Array (H,S,V) for the lower threshold bound of the HSV image
upper= np.array([185,219,207],np.uint8) # Array (H,S,V) for the upper threshold bound of the HSV image
